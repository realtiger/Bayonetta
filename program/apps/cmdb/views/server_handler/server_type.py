...
class ServerCreateData(BaseModel):
    name: str = Field(default="", description="主机名称", title="主机名称", example="name", min_length=1)
    ...
    port: int = Field(default="", description="端口", title="端口", example=22)
    idc: str = Field(default="", description="idc", title="idc", example="aws")
    admin_user: str = Field(default="", description="管理用户", title="管理用户", example="root")
